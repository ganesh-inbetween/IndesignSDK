...
#ifndef _MYPLUGIN2SERVICEPROVIDER_H_
#define _MYPLUGIN2SERVICEPROVIDER_H_
...
class MyPlugin2ServiceProvider : public CServiceProvider
{
public:
	MyPlugin2ServiceProvider(IPMUnknown*);
	~MyPlugin2ServiceProvider();
...
#endif //_MYPLUGIN2SERVICEPROVIDER_H_
