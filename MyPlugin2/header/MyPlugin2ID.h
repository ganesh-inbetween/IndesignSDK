...
//DECLARE_PMID(kClassIDSpace, kMyPlugin2SelectionObserverBoss, kMyPlugin2Prefix + 5)
...
DECLARE_PMID(kInterfaceIDSpace, IID_IMYSELECTIONOBSERVER, kMyPlugin2Prefix + 2)
...
DECLARE_PMID(kImplementationIDSpace, kMyPlugin2SelectionObserverImpl, kMyPlugin2Prefix + 4)
