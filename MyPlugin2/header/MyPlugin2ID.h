...
//DECLARE_PMID(kClassIDSpace, kDocBoss, kMyPlugin2Prefix + 4)
...
//DECLARE_PMID(kImplementationIDSpace, kMyPlugin2Impl, kMyPlugin2Prefix + 2)
//DECLARE_PMID(kImplementationIDSpace, kMyPlugin2Impl, kMyPlugin2Prefix + 3)
